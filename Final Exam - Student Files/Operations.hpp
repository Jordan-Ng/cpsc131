...
struct insert_at_back_of_dll
{
  ...
  void operator()( const SomeObject & object )
  {
    ...
    my_dll.push_back(std::move(object));
    /////////////////////// END-TO-DO (2) ////////////////////////////
  }
...
struct insert_at_back_of_sll
{
  ...
  void operator()( const SomeObject & object )
  {
    ...
    my_sll.insert_after(std::next(my_sll.before_begin(), std::distance(my_sll.begin(), my_sll.end())), std::move(object));
    /////////////////////// END-TO-DO (3) ////////////////////////////
  }
...
struct insert_at_front_of_dll
{
  ...
  void operator()( const SomeObject & object )
  {
    ...
    my_dll.push_front(std::move(object));
    /////////////////////// END-TO-DO (5) ////////////////////////////
  }
...
struct insert_at_front_of_sll
{
  ...
  void operator()( const SomeObject & object )
  {
    ...
    my_sll.push_front(std::move(object));
    /////////////////////// END-TO-DO (6) ////////////////////////////
  }
  ...
  void operator()( const auto & )
  {
    ...
    if (!my_sll.empty()) {
      for (auto i= my_sll.begin(); i!=my_sll.end(); ++i){
        if (std::next(i, 2) == my_sll.end()) my_sll.erase_after(i);
      }
    }
    /////////////////////// END-TO-DO (11) ////////////////////////////
  }
